      ...
      <div className="pointer-events-none absolute inset-0 z-[1] overflow-hidden">
        {disableScrollFx ? (
          <div aria-hidden className="absolute inset-[-2%]">
            ...
            {/* Campaign plate stays luminous; sculpted light only */}
        ...
        {/* Mid-distance haze — cools towers on the right so type can lead */}
        ...
        {/* Localized left read corridor — not a full hero wash */}
        ...
        {/* Skip a hard stop at y=0 — under the translucent fixed masthead it reads as a full-width hairline */}
        ...
        {/* Cinematic vignette — edge weight only */}
          ...
          >
            ...
            <div className="mt-6">
              ...
              <p className="mt-2 max-w-md font-sans text-[0.66rem] leading-relaxed tracking-[0.04em] text-fog-soft/48">
                Twin clubs · aquatics · 11-acre park spine — jump ahead if that&apos;s your first question.
              </p>
            </div>

            <p className="mt-7 font-sans text-[0.68rem] uppercase tracking-[0.36em] text-fog-soft/50">
              Campaign façade elevation · gallery & township bands carry matching WebP masters below
            </p>
          </motion.div>
        </div>
      </div>
